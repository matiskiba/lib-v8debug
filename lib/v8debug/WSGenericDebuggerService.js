...
var WSGenericDebuggerService = function(socket) {
    this.$socket = socket;
...
(function() {
    ...
    this.debuggerCommand = function(tabId, message) {
		// TODO: check is instance of GenericMessage
        this.$socket.send(JSON.stringify({command: "debugNode", body: message.toDict()}));
    };

}).call(WSGenericDebuggerService.prototype);

return WSGenericDebuggerService;
